...
<input type="text" name="name" class="form-control" placeholder="Write Your Name" style="color: black" required="">
  </div>
...
<input type="text" name="room" class="form-control" placeholder="Write Your Room No" style="color: black" required="">
  </div>
