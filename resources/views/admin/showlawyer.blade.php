     ...
     <div class="container-fluid" >   
          ...
          <div class="row ">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Lawyer Data</h4>
    ...
    @foreach($data as $lawyers)
            <tbody>
                ...
                <tr>
                  <td >{{$lawyers -> name}}</td>
                  <td >{{$lawyers -> phone}}</td>
                  <td >{{$lawyers -> speciality}}</td>
                  <td >${{$lawyers -> room}}</td>
                 <td ><img src="lawyerimage/{{$lawyers->image}}"></td>
                  <td>
                     <a  href="{{url('editlawyer',$lawyers->id)}}"  class="btn btn-success" onclick="return confirm('Are you sure to Edit this lawyer')" >Edit</a>
                  
                    </td>
                        <td>      
                     <a  href="{{url('removelawyer',$lawyers->id)}}"   class="btn btn-danger"  onclick="return confirm('Are you sure to Remove this lawyer')" >Remove</a>
