          ...
          <div class="row ">
                ...
                <th >Edit User</th>
                 <th >Delete User</th>
                  ...
                  <td>
                     <a  href="{{url('edituser',$users->id)}}"  class="badge badge-outline-success"  class="open-button" onclick="openForm()">Edit </a>
                  
                    </td>
                     <td>
                     <a  href="{{url('deleteuser',$users->id)}}"  class="badge badge-outline-danger" onclick="return confirm('Are You Sure To Remove This User')">Delete </a>
