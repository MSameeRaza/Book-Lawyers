                  ...
                  <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      ...
                      <div class="col-5 col-sm-7 col-xl-8 p-0">
                        <h4 class="mb-1 mb-sm-0">Welcome To Your Personal Panel</h4>
                        <p class="mb-0 font-weight-normal d-none d-sm-block">CBook your CV  and stay Tuned Wiyh US</p>
                      </div>
                      <div class="col-3 col-sm-2 col-xl-2 pl-0 text-center">
                        <span>
                          <a href="https://www.bootstrapdash.com/product/corona-admin-template/" target="_blank" class="btn btn-outline-light btn-rounded get-started-btn">Book Yoursel</a>
                        </span>
                      </div>
                    </div>
                  </div>
